...
. Die Erstellung von FlexVol Volumes bis zu einer maximalen Größe von 300 tib wird mit System Manager und der ONTAP CLI ab Cloud Volumes ONTAP 9.12.1 P2 und 9.13.0 P2 unterstützt.
